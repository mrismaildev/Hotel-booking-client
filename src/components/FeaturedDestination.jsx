  ...
  return (
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 bg-slate-50 py-20">
      ...
      <button
        ...
        className="flex flex-wrap items-center justify-center gap-6 mt-20 px-4 py-2 text-sm font-medium border border-gray-300 rounded hover:bg-gray-50 transition-all"
      >
